...
--test
CREATE TABLE EDU_APPLY_BOARD(
	BOARD_NO NUMBER  DEFAULT EDU_APPLY_BOARD_SEQ PRIMARY KEY,
	BOARD_TITLE VARCHAR2(100),
	BOARD_CONTENT CLOB,
	CATEGORY VARCHAR2(30),
	APPLY_STATUS VARCHAR2(30) DEFAULT '모집중',
	--CONSTRAINT PK_EDU_APPLY_BOARD PRIMARY KEY (BOARD_NO)
)
INSERT INTO EDU_APPLY_BOARD(BOARD_NO,BOARD_TITLE,BOARD_CONTENT,CATEGORY)
VALUES(EDU_APPLY_BOARD_SEQ.NEXTVAL,'BOARD_TITLE1','BOARD_CONTENT1','CATEGORY1');
