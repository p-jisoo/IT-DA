	...
	// App Declaration
		var internalApp = new cpr.core.App("udc/udcdialog", { 
			...
			onCreate: function(/* cpr.core.AppInstance */ app, exports) {
				...
				/*
				 * "Button" 버튼(ok)에서 click 이벤트 발생 시 호출.
				 * 사용자가 컨트롤을 클릭할 때 발생하는 이벤트.
				 */
				...
				// UI Configuration
				var button_1 = new cpr.controls.Button("ok");
				button_1.value = "Button";
				if(typeof onOkClick == "function") {
					button_1.addEventListener("click", onOkClick);
				}
				container.addChild(button_1, {
					"top": "272px",
					"left": "0px",
				...
				var button_2 = new cpr.controls.Button("no");
