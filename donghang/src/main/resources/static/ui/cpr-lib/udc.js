/// start - udc.detailrecipe
/*
 * UDC Qualified Name: udc.detailreciped
 * App URI: udc/detailrecipe
 * Source Location: udc/detailrecipe.clx
 *
...
(function(){
	// App Declaration
		var internalApp = new cpr.core.App("udc/detailrecipe", { 
			...
			onCreate: function(/* cpr.core.AppInstance */ app, exports) {
				...
				(function(container){
					...
					image_4.fallbackSrc = "theme/images/recipe/user_blank.png";
					image_4.style.css({
						"border-radius" : "100px"
					});
	...
	internalApp.title = "detailrecipe";
	
	// Type declaration for detailrecipe
	cpr.utils.Util.ensurePackage("udc").detailrecipe = function(id){
		cpr.controls.UDCBase.call(this, "udc.detailrecipe", internalApp, id);
	};
	
	udc.detailrecipe.prototype = Object.create(cpr.controls.UDCBase.prototype);
	Object.defineProperty(udc.detailrecipe.prototype, "type", {
		get : function(){
			return "udc.detailrecipe";
		},
...
<<<<<<< HEAD
/*
 * UDC Qualified Name: udc.udc_Btn
 * App URI: udc/udc_Btn
 * Source Location: udc/udc_Btn.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.4640), Don't edit manually.
 */
(function(){
	// App Declaration
		var internalApp = new cpr.core.App("udc/udc_Btn", { 
			onPrepare: function(loader) {
			},
			onCreate: function(/* cpr.core.AppInstance */ app, exports) {
				var linker = {};
	...
	internalApp.title = "udc_Btn";
	
	// Type declaration for udc_Btn
	cpr.utils.Util.ensurePackage("udc").udc_Btn = function(id){
		cpr.controls.UDCBase.call(this, "udc.udc_Btn", internalApp, id);
	};
	
	udc.udc_Btn.prototype = Object.create(cpr.controls.UDCBase.prototype);
	Object.defineProperty(udc.udc_Btn.prototype, "type", {
		get : function(){
			return "udc.udc_Btn";
		},
...
<<<<<<< HEAD
/*
 * UDC Qualified Name: udc.udcdialog
 * App URI: udc/udcdialog
 * Source Location: udc/udcdialog.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.4640), Don't edit manually.
 */
(function(){
	// App Declaration
		var internalApp = new cpr.core.App("udc/udcdialog", { 
			onPrepare: function(loader) {
			},
			onCreate: function(/* cpr.core.AppInstance */ app, exports) {
				var linker = {};
	...
	internalApp.title = "udcdialog";
	
	// Type declaration for udcdialog
	cpr.utils.Util.ensurePackage("udc").udcdialog = function(id){
		cpr.controls.UDCBase.call(this, "udc.udcdialog", internalApp, id);
	};
	
	udc.udcdialog.prototype = Object.create(cpr.controls.UDCBase.prototype);
	Object.defineProperty(udc.udcdialog.prototype, "type", {
		get : function(){
			return "udc.udcdialog";
		},
 ...
 * App URI: udc/udcDialogd
 * Source Location: udc/udcDialogd.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.4584), Don't edit manually.
 */
(function(){
	// App Declaration
		var internalApp = new cpr.core.App("udc/udcDialogd", { 
			onPrepare: function(loader) {
			},
			onCreate: function(/* cpr.core.AppInstance */ app, exports) {
				var linker = {};
				...
				(function(container){
					...
					output_5.value = "경기도 성남시 성남대로 34 하나프라자 6층 KOSTA EDU ";
					output_5.style.css({
						"color" : "#F6F6F6",
						"font-weight" : "bold",
						"font-size" : "16px"
					...
					output_6.value = " TEL : 010-8299-1244 | Email : gjsdms1244@gmail.com";
					output_6.style.css({
						"color" : "#F6F6F6",
						"font-weight" : "bold"
					});
					...
					output_7.value = "담당자 : 박지수 , 김지혁 , 이히은 , 강재헌";
					output_7.style.css({
						"color" : "#F6F6F6",
						"font-weight" : "bold",
						"font-size" : "16px"
	...
	internalApp.title = "udcDialogd";
	
	// Type declaration for udcDialogd
	cpr.utils.Util.ensurePackage("udc").udcDialogd = function(id){
		cpr.controls.UDCBase.call(this, "udc.udcDialogd", internalApp, id);
	};
	
	udc.udcDialogd.prototype = Object.create(cpr.controls.UDCBase.prototype);
	Object.defineProperty(udc.udcDialogd.prototype, "type", {
		get : function(){
			return "udc.udcDialogd";
		},
