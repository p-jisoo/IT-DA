...
/// end - udc.udcdialog
/// start - udc.udcdialog2
/*
 * UDC Qualified Name: udc.udcdialog2
 * App URI: udc/udcdialog2
 * Source Location: udc/udcdialog2.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.4584), Don't edit manually.
 */
(function(){
	// App Declaration
		var internalApp = new cpr.core.App("udc/udcdialog2", { 
			onPrepare: function(loader) {
			},
			onCreate: function(/* cpr.core.AppInstance */ app, exports) {
				var linker = {};
	...
	internalApp.title = "udcdialog2";
	
	// Type declaration for udcdialog2
	cpr.utils.Util.ensurePackage("udc").udcdialog2 = function(id){
		cpr.controls.UDCBase.call(this, "udc.udcdialog2", internalApp, id);
	};
	
	udc.udcdialog2.prototype = Object.create(cpr.controls.UDCBase.prototype);
	Object.defineProperty(udc.udcdialog2.prototype, "type", {
		get : function(){
			return "udc.udcdialog2";
		},
