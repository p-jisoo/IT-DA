...
(function() {
	var app = new cpr.core.App("detailBoard", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			var button_11 = new cpr.controls.Button("apply");
			button_11.visible = false;
			button_11.readOnly = true;
			button_11.bind("value").toDataMap(app.lookup("eduApplyBoardMap"), "btnApply");
			if(typeof onApplyClick == "function") {
				button_11.addEventListener("click", onApplyClick);
			}
			if(typeof onApplyValueChange == "function") {
