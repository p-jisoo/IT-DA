...
(function() {
	var app = new cpr.core.App("detailBoard", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			if(typeof onDeleteCommentsmsSubmitSuccess == "function") {
				submission_5.addEventListener("submit-success", onDeleteCommentsmsSubmitSuccess);
			}
			...
			if(typeof onListButtonClick == "function") {
				button_1.addEventListener("click", onListButtonClick);
			}
			...
			var button_2 = new cpr.controls.Button("updateButton");
			...
			var button_3 = new cpr.controls.Button("deleteButton");
			...
			if(typeof onGrd1CellClick2 == "function") {
				grid_1.addEventListener("cell-click", onGrd1CellClick2);
			}
