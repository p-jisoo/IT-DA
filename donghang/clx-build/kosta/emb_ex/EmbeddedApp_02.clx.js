/*
 * App URI: kosta/emb_ex/EmbeddedApp_02
 * Source Location: kosta/emb_ex/EmbeddedApp_02.clx
 *
 * This file was generated by eXBuilder6 compiler(1.0.4584), Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("kosta/emb_ex/EmbeddedApp_02", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			// Header
			app.declareAppProperty("appId", "임베디드앱02");
			...
			// UI Configuration
			var output_1 = new cpr.controls.Output("output5");
			output_1.value = "두번째 페이지";
			...
			(function(container){
				var output_2 = new cpr.controls.Output("output1");
				...
				var output_3 = new cpr.controls.Output("output2");
				...
				var output_4 = new cpr.controls.Output("output3");
				output_4.value = "앱 속성";
				...
				var output_6 = new cpr.controls.Output("output4");
				output_6.value = "앱 함수";
				...
				(function(container){
					var output_8 = new cpr.controls.Output("output6");
					...
					var output_9 = new cpr.controls.Output("output7");
